...
public class PathsOfWeight7
{
        ...
        public static void findPathsOfLength7(Graph graph, Vertex start, Vertex end) {
            ...
            dfs(graph, start, end, 0.0, 7.0, path, visited);
        }

        private static void dfs(Graph graph, Vertex current, Vertex end,
                                double currentLength, double targetLength,
                                ArrayList<Vertex> path, HashSet<Vertex> visited) {
